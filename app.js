/************************************************************************
 * Objetivo: Iniciar os primeiros comandos no Node.JS
 * Autor: André
 * Data: 29/07/2025
 * Versão: 1.0
 * ***********************************************************************/
...
entradaDeDados.question('Digite seu nome:', function(nome) {
    ...
    if(nomeUsuario == ''){
        ...
        //toUppercase() Converte o conteudo em uma string em maisuculo
...
//typeof -> permite mostrar o tipo de dados de um objeto ou varíavel 
